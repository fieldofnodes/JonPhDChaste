...
class TestCapsuleAttractiveEndsForce2dDivisionOneCapsule : public AbstractCellBasedTestSuite
{
public:
	...
	void TestAttractiveEnds2dCapsuleDivision()
	{
		...
		simulator.SetOutputDirectory("TestAttractiveEndsDivision2dOneCapsule");
