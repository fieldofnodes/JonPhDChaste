...
template<unsigned ELEMENT_DIM, unsigned SPACE_DIM>
double AlignmentCapsuleForce<ELEMENT_DIM,SPACE_DIM>::CalculateOverlapBetweenCapsules(
...
template <unsigned ELEMENT_DIM, unsigned SPACE_DIM>
double AlignmentCapsuleForce<ELEMENT_DIM, SPACE_DIM>::CalculateForceDirectionAndContactPoints(Node<SPACE_DIM>& rNodeA,
                                                                                     Node<SPACE_DIM>& rNodeB,
...
template<unsigned ELEMENT_DIM, unsigned SPACE_DIM>
double AlignmentCapsuleForce<ELEMENT_DIM,SPACE_DIM>::CalculateForceMagnitude(const double overlap,
