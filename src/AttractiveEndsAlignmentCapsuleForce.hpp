...
#ifndef ATTRACTIVEENDSALIGNMENTCAPSULEFORCE_HPP_
#define ATTRACTIVEENDSALIGNMENTCAPSULEFORCE_HPP_
...
class AttractiveEndsAlignmentCapsuleForce : public CapsuleForce<ELEMENT_DIM, SPACE_DIM>
{
    friend class TestAttractiveEndsAlignmentCapsuleForce;
...
public:
     ...
     * Constructor.
     */
    AttractiveEndsAlignmentCapsuleForce();

    /**
     * Destructor.
     */
    virtual ~AttractiveEndsAlignmentCapsuleForce() = default;
...
#endif /*ATTRACTIVEENDSALIGNMENTCAPSULEFORCE_HPP_*/
