...
void AttractiveEndsAlignmentCapsuleForce<ELEMENT_DIM, SPACE_DIM>::SetGamma(double Gamma)
...
template <unsigned ELEMENT_DIM, unsigned SPACE_DIM>
double AttractiveEndsAlignmentCapsuleForce<ELEMENT_DIM, SPACE_DIM>::GetGamma()
...
template <unsigned ELEMENT_DIM, unsigned SPACE_DIM>
AttractiveEndsAlignmentCapsuleForce<ELEMENT_DIM, SPACE_DIM>::AttractiveEndsAlignmentCapsuleForce()
...
template<unsigned ELEMENT_DIM, unsigned SPACE_DIM>
double AttractiveEndsAlignmentCapsuleForce<ELEMENT_DIM,SPACE_DIM>::CalculateOverlapBetweenCapsules(
...
template <unsigned ELEMENT_DIM, unsigned SPACE_DIM>
double AttractiveEndsAlignmentCapsuleForce<ELEMENT_DIM, SPACE_DIM>::CalculateForceDirectionAndContactPoints(Node<SPACE_DIM>& rNodeA,
                                                                                     Node<SPACE_DIM>& rNodeB,
...
template<unsigned ELEMENT_DIM, unsigned SPACE_DIM>
double AttractiveEndsAlignmentCapsuleForce<ELEMENT_DIM,SPACE_DIM>::CalculateForceMagnitude(const double overlap,
...
template<unsigned ELEMENT_DIM, unsigned SPACE_DIM>
void AttractiveEndsAlignmentCapsuleForce<ELEMENT_DIM,SPACE_DIM>::AddForceContribution(AbstractCellPopulation<ELEMENT_DIM,SPACE_DIM>& rCellPopulation)
{
    ...
    for (auto& node_pair : p_cell_population->rGetNodePairs())
    {
        ...
        if (overlap > -1.0*deltastar)
		{
			...
			{
				r_node_a.rGetNodeAttributes()[NA_APPLIED_THETA] += (-1.0)*mGamma*sin(2*(angle_theta_a-angle_theta_b));
				r_node_b.rGetNodeAttributes()[NA_APPLIED_THETA] += mGamma*sin(2*(angle_theta_a-angle_theta_b));
			}
...
template<unsigned ELEMENT_DIM, unsigned SPACE_DIM>
void AttractiveEndsAlignmentCapsuleForce<ELEMENT_DIM,SPACE_DIM>::OutputForceParameters(out_stream& rParamsFile)
{
...
template class AttractiveEndsAlignmentCapsuleForce<1,1>;
template class AttractiveEndsAlignmentCapsuleForce<1,2>;
template class AttractiveEndsAlignmentCapsuleForce<2,2>;
template class AttractiveEndsAlignmentCapsuleForce<1,3>;
template class AttractiveEndsAlignmentCapsuleForce<2,3>;
template class AttractiveEndsAlignmentCapsuleForce<3,3>;

// Serialization for Boost >= 1.36
#include "SerializationExportWrapperForCpp.hpp"
EXPORT_TEMPLATE_CLASS_ALL_DIMS(AttractiveEndsAlignmentCapsuleForce)
